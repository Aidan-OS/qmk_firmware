...
[_MAIN] = LAYOUT_single_space(
    KC_ESC  , KC_Q    , KC_W    , KC_E      , KC_R    , KC_T      , KC_Y       , KC_U    , KC_I    , KC_O     , KC_P     , KC_BSPC ,
    LT3_TAB , KC_A    , KC_S    , KC_D      , KC_F    , KC_G      , KC_H       , KC_J    , KC_K    , KC_L     , KC_SCLN  , KC_ENT  ,
    KC_LSFT , KC_Z    , KC_X    , KC_C      , KC_V    , KC_B      , KC_N       , KC_M    , KC_COMM , KC_DOT   , KC_SLSH  , KC_QUOT ,
    KC_LCTL , KC_LGUI , KC_LALT , MO(_LEFT) , KC_SPC , MO(_RIGHT) , KC_LEFT    , KC_DOWN , KC_UP   , KC_RIGHT , KC_MPLY
),

[_LEFT] = LAYOUT_single_space( /* LEFT */
...
[_RIGHT] = LAYOUT_single_space( /* RIGHT */
  ...
  _______  , _______    , _______ , _______ , _______   , _______    , KC_MUTE       , KC_VOLD      , KC_VOLU     , KC_MPLY       , _______
),

[_TAB] = LAYOUT_single_space( /* Tab */
